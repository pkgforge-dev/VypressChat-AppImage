...
ARCH=$(uname -m)
VERSION=2.1.9 # example command to get version of application here
export ARCH VERSION
export OUTPATH=./dist
export ADD_HOOKS="self-updater.hook"
export UPINFO="gh-releases-zsync|${GITHUB_REPOSITORY%/*}|${GITHUB_REPOSITORY#*/}|latest|*$ARCH.AppImage.zsync"
export APPNAME=VypressChat # change the application name here
...
COMMENT_NAME="Vypress Chat is designed for office and home networks." # example: Simple and powerful audio player
CATEGORIES_NAME="Network;" # example: AudioVideo;Audio;Player;
